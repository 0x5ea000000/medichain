...
func GetTxCmd() *cobra.Command {
	...
	cmd.AddCommand(CmdCreateServiceUserBatch())

	cmd.AddCommand(CmdUnbanUser())

	cmd.AddCommand(CmdBanUser())

	cmd.AddCommand(CmdDeleteSharingBatch())

	cmd.AddCommand(CmdUpdateSharingStatusBatch())
